...
public class Configuration {
    ...
    public static final String CMD_COMPUTING_RESOURCE_QUERY = "vboxmanage metrics query '*' CPU/Load/User,CPU/Load/User:avg,RAM/Usage/Used,RAM/Usage/Used:avg,Net/Rate/Rx,Net/Rate/Rx:avg,Net/Rate/Tx,Net/Rate/Tx:avg";
